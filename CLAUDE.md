...
このシステムをあなたのPCにダウンロード＆セットアップしますか？
（リポジトリのクローン・必要ファイルの作成・Googleとの連携設定まで行います）
...
**「y」が返ってきたら、続けて以下のメッセージを送ってください。返答を待ってください。**

---

```
セットアップを始めます。以下をこのチャットに貼り付けて送ってください👇

---
【セットアップ情報】
Googleアカウント: xxx@gmail.com
名前・ビジネスネーム:
得意領域:
実績（箇条書きでOK）:
応募したくない仕事:
...
**ユーザーから【セットアップ情報】が届いたら、以下のステップを順番に実行してください。**
